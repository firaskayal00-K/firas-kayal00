    ...
    <section className="mx-4 flex flex-col gap-8 rounded-[28px] bg-ink px-5 py-11 text-paper sm:mx-8 sm:rounded-[36px] sm:px-9 sm:py-14 lg:mx-14 lg:gap-14 lg:px-18 lg:py-22">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        <div className="grid grid-cols-2 gap-3 lg:col-span-7">
          {c.bigStats.stats.map((s, i) => (
            <Reveal key={s.label} delay={Math.min(i * 0.08, 0.3)}>
              <div className="flex flex-col gap-2.5 rounded-[22px] border border-ink-border bg-ink-soft px-5 py-6 sm:gap-3 sm:rounded-[26px] sm:px-7 sm:py-7">
        ...
        <Reveal delay={0.15} className="lg:col-span-5" onVisible={() => setBarsVisible(true)}>
          <div className="flex flex-col gap-5 rounded-[22px] border border-ink-border bg-ink-soft p-6 sm:gap-6 sm:rounded-[26px] sm:p-8">
