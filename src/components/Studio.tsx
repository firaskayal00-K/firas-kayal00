...
export function Studio({ c }: { c: SiteContent }) {
  return (
    <section id="studio" className="grid grid-cols-1 items-center gap-10 px-4 py-16 sm:px-8 lg:grid-cols-12 lg:gap-6 lg:px-14 lg:py-28">
      <div className="bk-photo relative order-1 h-[280px] overflow-hidden rounded-[28px] sm:h-[420px] lg:order-none lg:col-span-6 lg:h-[680px] lg:rounded-[32px]">
      ...
      <div className="flex flex-col gap-5 lg:col-span-6 lg:col-start-8 lg:gap-6">
